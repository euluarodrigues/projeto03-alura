...
public class SerieController {
    ...
    public List<SerieDTO> obterSeriesLancamentos() {
        return service.obterSeriesLancamentos();
    }
    ...
    public List<EpisodiosDTO> obterTemporada(@PathVariable Long id, @PathVariable Integer temporada) {
        return service.obterTemporada(id, temporada);
    }

    @GetMapping("/categoria/{genero}")
    public List<SerieDTO> obterTemporada(@PathVariable String genero) {
